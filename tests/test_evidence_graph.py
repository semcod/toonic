...
class TestEvidenceGraphBuilder:
    ...
    def test_toon_generation(self):
        ...
        builder.add_video_evidence(
            "cam.mp4", [{"ts": 5.0, "score": 0.5, "b64": "", "size": 100}]
        )
        builder.add_audio_evidence(
            "audio.wav", [{"start": 3.0, "duration": 1.0, "b64": "", "size": 50}]
        )
